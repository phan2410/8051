...
#define LCD_D6 P1_6
#define LCD_D7 P1_7
unsigned n5,n4,n3,n2,n1,n0, delay, even, time, oldspeed, speed;
/************************************/
...
/*************************interrupt timer 1****************************/
void tmr1isr() interrupt 3{
	--time;
	if(time==39){
		oldspeed=n5*100000+n4*10000+n3*1000+n2*100+n1*10+n0;
	}else if (time==0){
		speed=n5*100000+n4*10000+n3*1000+n2*100+n1*10+n0-oldspeed;
		time=40;
	}
}
/******************Ctr chinh**************************/
void main(){
        ...
        while(1){
					...
					LCD_PutChar('0'+n0);
					LCD_Gotoxy(11,1);
					LCD_PutChar('0'+speed/100);
					LCD_PutChar('0'+(speed%100)/10);
					LCD_PutChar('0'+(speed%100)%10);
				}
}