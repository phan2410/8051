#include <AT89X52.H>
unsigned loopcount0,loopcount1, speedlimit, delay;
...
void tmr1isr() interrupt TF1_VECTOR{
	if (--loopcount1==0){
		P1_3=~P1_3;
		loopcount1=3*speedlimit;
	}else if (loopcount1==speedlimit){
		P1_4=P1_3;
	}
}
void main(void){
	...
	TH1=9;
	TL1=9;
	for (delay=0;delay<50000;delay++){};//delay for stablility
	speedlimit=111;
	loopcount0=3*speedlimit;
	loopcount1=3*speedlimit;
	TR0=1;
	while(TR1==0){
		if (loopcount0==speedlimit){
			TR1=1;
			TL1=TL0;
		}
	}
